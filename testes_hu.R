...
cor.test(bd$shaps, bd$anos_estudo)
cor.test(bd$shaps, bd$quant_pessoas)
cor.test(bd$shaps, bd$cigarros_semana)
cor.test(bd$shaps, bd$tempo_tabagismo)
cor.test(bd$shaps, bd$exercicio_tempo)
cor.test(bd$shaps, bd$internacao_quant)
cor.test(bd$shaps, bd$internacao_geral_quant)
...
cor.test(bd$acips_total, bd$anos_estudo)
cor.test(bd$acips_total, bd$quant_pessoas)
cor.test(bd$acips_total, bd$cigarros_semana)
cor.test(bd$acips_total, bd$tempo_tabagismo)
cor.test(bd$acips_total, bd$exercicio_tempo)
cor.test(bd$acips_total, bd$internacao_quant)
cor.test(bd$acips_total, bd$internacao_geral_quant)
...
cor.test(bd$teps_total, bd$anos_estudo)
cor.test(bd$teps_total, bd$quant_pessoas)
cor.test(bd$teps_total, bd$cigarros_semana)
cor.test(bd$teps_total, bd$tempo_tabagismo)
cor.test(bd$teps_total, bd$exercicio_tempo)
cor.test(bd$teps_total, bd$internacao_quant)
cor.test(bd$teps_total, bd$internacao_geral_quant)
...
cor.test(bd$hads_total, bd$anos_estudo)
cor.test(bd$hads_total, bd$quant_pessoas)
cor.test(bd$hads_total, bd$cigarros_semana)
cor.test(bd$hads_total, bd$tempo_tabagismo)
cor.test(bd$hads_total, bd$exercicio_tempo)
cor.test(bd$hads_total, bd$internacao_quant)
cor.test(bd$hads_total, bd$internacao_geral_quant)
...
cor.test(bd$neuroticismo, bd$anos_estudo)
cor.test(bd$neuroticismo, bd$quant_pessoas)
cor.test(bd$neuroticismo, bd$cigarros_semana)
cor.test(bd$neuroticismo, bd$tempo_tabagismo)
cor.test(bd$neuroticismo, bd$exercicio_tempo)
cor.test(bd$neuroticismo, bd$internacao_quant)
cor.test(bd$neuroticismo, bd$internacao_geral_quant)
...
cor.test(bd$idade, bd$anos_estudo)
cor.test(bd$idade, bd$quant_pessoas)
cor.test(bd$idade, bd$cigarros_semana)
cor.test(bd$idade, bd$tempo_tabagismo)
cor.test(bd$idade, bd$exercicio_tempo)
cor.test(bd$idade, bd$internacao_quant)
cor.test(bd$idade, bd$internacao_geral_quant)
...
cor.test(bd$tempo_casado, bd$anos_estudo)
cor.test(bd$tempo_casado, bd$quant_pessoas)
cor.test(bd$tempo_casado, bd$cigarros_semana)
cor.test(bd$tempo_casado, bd$tempo_tabagismo)
cor.test(bd$tempo_casado, bd$exercicio_tempo)
cor.test(bd$tempo_casado, bd$internacao_quant)
cor.test(bd$tempo_casado, bd$internacao_geral_quant)
...
cor.test(bd$num_filhos, bd$anos_estudo)
cor.test(bd$num_filhos, bd$quant_pessoas)
cor.test(bd$num_filhos, bd$cigarros_semana)
cor.test(bd$num_filhos, bd$tempo_tabagismo)
cor.test(bd$num_filhos, bd$exercicio_tempo)
cor.test(bd$num_filhos, bd$internacao_quant)
cor.test(bd$num_filhos, bd$internacao_geral_quant)

#renda
cor.test(bd$renda_familia, bd$peso) #p = 0,7628
cor.test(bd$renda_familia, bd$altura) #p = 0,7886

cor.test(bd$renda_familia, bd$anos_estudo)
cor.test(bd$renda_familia, bd$quant_pessoas)
cor.test(bd$renda_familia, bd$cigarros_semana)
cor.test(bd$renda_familia, bd$tempo_tabagismo)
cor.test(bd$renda_familia, bd$exercicio_tempo)
cor.test(bd$renda_familia, bd$internacao_quant)
cor.test(bd$renda_familia, bd$internacao_geral_quant)

#peso
cor.test(bd$peso, bd$altura) #p = 0,0307

cor.test(bd$peso, bd$anos_estudo)
cor.test(bd$peso, bd$quant_pessoas)
cor.test(bd$peso, bd$cigarros_semana)
cor.test(bd$peso, bd$tempo_tabagismo)
cor.test(bd$peso, bd$exercicio_tempo)
cor.test(bd$peso, bd$internacao_quant)
cor.test(bd$peso, bd$internacao_geral_quant)

#altura

cor.test(bd$altura, bd$anos_estudo)
cor.test(bd$altura, bd$quant_pessoas)
cor.test(bd$altura, bd$cigarros_semana)
cor.test(bd$altura, bd$tempo_tabagismo)
cor.test(bd$altura, bd$exercicio_tempo)
cor.test(bd$altura, bd$internacao_quant)
cor.test(bd$altura, bd$internacao_geral_quant)
...
cor.test(bd$hads_ans, bd$anos_estudo)
cor.test(bd$hads_ans, bd$quant_pessoas)
cor.test(bd$hads_ans, bd$cigarros_semana)
cor.test(bd$hads_ans, bd$tempo_tabagismo)
cor.test(bd$hads_ans, bd$exercicio_tempo)
cor.test(bd$hads_ans, bd$internacao_quant)
cor.test(bd$hads_ans, bd$internacao_geral_quant)
...
cor.test(bd$hads_dep, bd$anos_estudo)
cor.test(bd$hads_dep, bd$quant_pessoas)
cor.test(bd$hads_dep, bd$cigarros_semana)
cor.test(bd$hads_dep, bd$tempo_tabagismo)
cor.test(bd$hads_dep, bd$exercicio_tempo)
cor.test(bd$hads_dep, bd$internacao_quant)
cor.test(bd$hads_dep, bd$internacao_geral_quant)
...
cor.test(bd$bas_total, bd$anos_estudo)
cor.test(bd$bas_total, bd$quant_pessoas)
cor.test(bd$bas_total, bd$cigarros_semana)
cor.test(bd$bas_total, bd$tempo_tabagismo)
cor.test(bd$bas_total, bd$exercicio_tempo)
cor.test(bd$bas_total, bd$internacao_quant)
cor.test(bd$bas_total, bd$internacao_geral_quant)

#bis_total
cor.test(bd$bis_total, bd$panas_pos)
cor.test(bd$bis_total, bd$panas_neg)
cor.test(bd$bis_total, bd$quesi_total)
cor.test(bd$bis_total, bd$quesi_abuso_emoc)
cor.test(bd$bis_total, bd$quesi_neglig_emoc)
cor.test(bd$bis_total, bd$quesi_abuso_sex)
cor.test(bd$bis_total, bd$quesi_abuso_fis)
cor.test(bd$bis_total, bd$quesi_neglig_fis)

cor.test(bd$bis_total, bd$idade) 
cor.test(bd$bis_total, bd$tempo_casado) 
cor.test(bd$bis_total, bd$num_filhos) 
cor.test(bd$bis_total, bd$renda_familia) 
cor.test(bd$bis_total, bd$peso) 
cor.test(bd$bis_total, bd$altura) 

cor.test(bd$bis_total, bd$hemacias)
cor.test(bd$bis_total, bd$hemoglobina)
cor.test(bd$bis_total, bd$hematocrito)
cor.test(bd$bis_total, bd$volumeglob) 
cor.test(bd$bis_total, bd$hemoglobina_m) 
cor.test(bd$bis_total, bd$hemoglobina_concent)
cor.test(bd$bis_total, bd$rdw) 
cor.test(bd$bis_total, bd$leucocitos)
cor.test(bd$bis_total, bd$segmentados)
cor.test(bd$bis_total, bd$segmentados_m)
cor.test(bd$bis_total, bd$bastonados)
cor.test(bd$bis_total, bd$linfocitos)
cor.test(bd$bis_total, bd$linfocitos_m) 
cor.test(bd$bis_total, bd$monocitos) 
cor.test(bd$bis_total, bd$monocitos_m)
cor.test(bd$bis_total, bd$eosinofilos)
cor.test(bd$bis_total, bd$eosinofilos_m) 
cor.test(bd$bis_total, bd$basofilos) 
cor.test(bd$bis_total, bd$basofilos_m)
cor.test(bd$bis_total, bd$plaquetas) 
cor.test(bd$bis_total, bd$plaquetas_vol)
cor.test(bd$bis_total, bd$PCR)
cor.test(bd$bis_total, bd$CRH)
cor.test(bd$bis_total, bd$cortisol)

cor.test(bd$bis_total, bd$anos_estudo)
cor.test(bd$bis_total, bd$quant_pessoas)
cor.test(bd$bis_total, bd$cigarros_semana)
cor.test(bd$bis_total, bd$tempo_tabagismo)
cor.test(bd$bis_total, bd$exercicio_tempo)
cor.test(bd$bis_total, bd$internacao_quant)
cor.test(bd$bis_total, bd$internacao_geral_quant)

#panas_pos
cor.test(bd$panas_pos, bd$panas_neg)
cor.test(bd$panas_pos, bd$quesi_total)
cor.test(bd$panas_pos, bd$quesi_abuso_emoc)
cor.test(bd$panas_pos, bd$quesi_neglig_emoc)
cor.test(bd$panas_pos, bd$quesi_abuso_sex)
cor.test(bd$panas_pos, bd$quesi_abuso_fis)
cor.test(bd$panas_pos, bd$quesi_neglig_fis)

cor.test(bd$panas_pos, bd$idade) 
cor.test(bd$panas_pos, bd$tempo_casado) 
cor.test(bd$panas_pos, bd$num_filhos) 
cor.test(bd$panas_pos, bd$renda_familia) 
cor.test(bd$panas_pos, bd$peso) 
cor.test(bd$panas_pos, bd$altura) 

cor.test(bd$panas_pos, bd$hemacias)
cor.test(bd$panas_pos, bd$hemoglobina)
cor.test(bd$panas_pos, bd$hematocrito)
cor.test(bd$panas_pos, bd$volumeglob) 
cor.test(bd$panas_pos, bd$hemoglobina_m) 
cor.test(bd$panas_pos, bd$hemoglobina_concent)
cor.test(bd$panas_pos, bd$rdw) 
cor.test(bd$panas_pos, bd$leucocitos)
cor.test(bd$panas_pos, bd$segmentados)
cor.test(bd$panas_pos, bd$segmentados_m)
cor.test(bd$panas_pos, bd$bastonados)
cor.test(bd$panas_pos, bd$linfocitos)
cor.test(bd$panas_pos, bd$linfocitos_m) 
cor.test(bd$panas_pos, bd$monocitos) 
cor.test(bd$panas_pos, bd$monocitos_m)
cor.test(bd$panas_pos, bd$eosinofilos)
cor.test(bd$panas_pos, bd$eosinofilos_m) 
cor.test(bd$panas_pos, bd$basofilos) 
cor.test(bd$panas_pos, bd$basofilos_m)
cor.test(bd$panas_pos, bd$plaquetas) 
cor.test(bd$panas_pos, bd$plaquetas_vol)
cor.test(bd$panas_pos, bd$PCR)
cor.test(bd$panas_pos, bd$CRH)
cor.test(bd$panas_pos, bd$cortisol)

cor.test(bd$panas_pos, bd$anos_estudo)
cor.test(bd$panas_pos, bd$quant_pessoas)
cor.test(bd$panas_pos, bd$cigarros_semana)
cor.test(bd$panas_pos, bd$tempo_tabagismo)
cor.test(bd$panas_pos, bd$exercicio_tempo)
cor.test(bd$panas_pos, bd$internacao_quant)
cor.test(bd$panas_pos, bd$internacao_geral_quant)

#panas_neg
cor.test(bd$panas_neg, bd$quesi_total)
cor.test(bd$panas_neg, bd$quesi_abuso_emoc)
cor.test(bd$panas_neg, bd$quesi_neglig_emoc)
cor.test(bd$panas_neg, bd$quesi_abuso_sex)
cor.test(bd$panas_neg, bd$quesi_abuso_fis)
cor.test(bd$panas_neg, bd$quesi_neglig_fis)

cor.test(bd$panas_neg, bd$idade) 
cor.test(bd$panas_neg, bd$tempo_casado) 
cor.test(bd$panas_neg, bd$num_filhos) 
cor.test(bd$panas_neg, bd$renda_familia) 
cor.test(bd$panas_neg, bd$peso) 
cor.test(bd$panas_neg, bd$altura) 

cor.test(bd$panas_neg, bd$hemacias)
cor.test(bd$panas_neg, bd$hemoglobina)
cor.test(bd$panas_neg, bd$hematocrito)
cor.test(bd$panas_neg, bd$volumeglob) 
cor.test(bd$panas_neg, bd$hemoglobina_m) 
cor.test(bd$panas_neg, bd$hemoglobina_concent)
cor.test(bd$panas_neg, bd$rdw) 
cor.test(bd$panas_neg, bd$leucocitos)
cor.test(bd$panas_neg, bd$segmentados)
cor.test(bd$panas_neg, bd$segmentados_m)
cor.test(bd$panas_neg, bd$bastonados)
cor.test(bd$panas_neg, bd$linfocitos)
cor.test(bd$panas_neg, bd$linfocitos_m) 
cor.test(bd$panas_neg, bd$monocitos) 
cor.test(bd$panas_neg, bd$monocitos_m)
cor.test(bd$panas_neg, bd$eosinofilos)
cor.test(bd$panas_neg, bd$eosinofilos_m) 
cor.test(bd$panas_neg, bd$basofilos) 
cor.test(bd$panas_neg, bd$basofilos_m)
cor.test(bd$panas_neg, bd$plaquetas) 
cor.test(bd$panas_neg, bd$plaquetas_vol)
cor.test(bd$panas_neg, bd$PCR)
cor.test(bd$panas_neg, bd$CRH)
cor.test(bd$panas_neg, bd$cortisol)

cor.test(bd$panas_neg, bd$anos_estudo)
cor.test(bd$panas_neg, bd$quant_pessoas)
cor.test(bd$panas_neg, bd$cigarros_semana)
cor.test(bd$panas_neg, bd$tempo_tabagismo)
cor.test(bd$panas_neg, bd$exercicio_tempo)
cor.test(bd$panas_neg, bd$internacao_quant)
cor.test(bd$panas_neg, bd$internacao_geral_quant)

#quesi_total
cor.test(bd$quesi_total, bd$quesi_abuso_emoc)
cor.test(bd$quesi_total, bd$quesi_neglig_emoc)
cor.test(bd$quesi_total, bd$quesi_abuso_sex)
cor.test(bd$quesi_total, bd$quesi_abuso_fis)
cor.test(bd$quesi_total, bd$quesi_neglig_fis)

cor.test(bd$quesi_total, bd$idade) 
cor.test(bd$quesi_total, bd$tempo_casado) 
cor.test(bd$quesi_total, bd$num_filhos) 
cor.test(bd$quesi_total, bd$renda_familia) 
cor.test(bd$quesi_total, bd$peso) 
cor.test(bd$quesi_total, bd$altura) 

cor.test(bd$quesi_total, bd$hemacias)
cor.test(bd$quesi_total, bd$hemoglobina)
cor.test(bd$quesi_total, bd$hematocrito)
cor.test(bd$quesi_total, bd$volumeglob) 
cor.test(bd$quesi_total, bd$hemoglobina_m) 
cor.test(bd$quesi_total, bd$hemoglobina_concent)
cor.test(bd$quesi_total, bd$rdw) 
cor.test(bd$quesi_total, bd$leucocitos)
cor.test(bd$quesi_total, bd$segmentados)
cor.test(bd$quesi_total, bd$segmentados_m)
cor.test(bd$quesi_total, bd$bastonados)
cor.test(bd$quesi_total, bd$linfocitos)
cor.test(bd$quesi_total, bd$linfocitos_m) 
cor.test(bd$quesi_total, bd$monocitos) 
cor.test(bd$quesi_total, bd$monocitos_m)
cor.test(bd$quesi_total, bd$eosinofilos)
cor.test(bd$quesi_total, bd$eosinofilos_m) 
cor.test(bd$quesi_total, bd$basofilos) 
cor.test(bd$quesi_total, bd$basofilos_m)
cor.test(bd$quesi_total, bd$plaquetas) 
cor.test(bd$quesi_total, bd$plaquetas_vol)
cor.test(bd$quesi_total, bd$PCR)
cor.test(bd$quesi_total, bd$CRH)
cor.test(bd$quesi_total, bd$cortisol)

cor.test(bd$quesi_total, bd$anos_estudo)
cor.test(bd$quesi_total, bd$quant_pessoas)
cor.test(bd$quesi_total, bd$cigarros_semana)
cor.test(bd$quesi_total, bd$tempo_tabagismo)
cor.test(bd$quesi_total, bd$exercicio_tempo)
cor.test(bd$quesi_total, bd$internacao_quant)
cor.test(bd$quesi_total, bd$internacao_geral_quant)

#quesi_abuso_emoc
cor.test(bd$quesi_abuso_emoc, bd$quesi_neglig_emoc)
cor.test(bd$quesi_abuso_emoc, bd$quesi_abuso_sex)
cor.test(bd$quesi_abuso_emoc, bd$quesi_abuso_fis)
cor.test(bd$quesi_abuso_emoc, bd$quesi_neglig_fis)

cor.test(bd$quesi_abuso_emoc, bd$idade) 
cor.test(bd$quesi_abuso_emoc, bd$tempo_casado) 
cor.test(bd$quesi_abuso_emoc, bd$num_filhos) 
cor.test(bd$quesi_abuso_emoc, bd$renda_familia) 
cor.test(bd$quesi_abuso_emoc, bd$peso) 
cor.test(bd$quesi_abuso_emoc, bd$altura) 

cor.test(bd$quesi_abuso_emoc, bd$hemacias)
cor.test(bd$quesi_abuso_emoc, bd$hemoglobina)
cor.test(bd$quesi_abuso_emoc, bd$hematocrito)
cor.test(bd$quesi_abuso_emoc, bd$volumeglob) 
cor.test(bd$quesi_abuso_emoc, bd$hemoglobina_m) 
cor.test(bd$quesi_abuso_emoc, bd$hemoglobina_concent)
cor.test(bd$quesi_abuso_emoc, bd$rdw) 
cor.test(bd$quesi_abuso_emoc, bd$leucocitos)
cor.test(bd$quesi_abuso_emoc, bd$segmentados)
cor.test(bd$quesi_abuso_emoc, bd$segmentados_m)
cor.test(bd$quesi_abuso_emoc, bd$bastonados)
cor.test(bd$quesi_abuso_emoc, bd$linfocitos)
cor.test(bd$quesi_abuso_emoc, bd$linfocitos_m) 
cor.test(bd$quesi_abuso_emoc, bd$monocitos) 
cor.test(bd$quesi_abuso_emoc, bd$monocitos_m)
cor.test(bd$quesi_abuso_emoc, bd$eosinofilos)
cor.test(bd$quesi_abuso_emoc, bd$eosinofilos_m) 
cor.test(bd$quesi_abuso_emoc, bd$basofilos) 
cor.test(bd$quesi_abuso_emoc, bd$basofilos_m)
cor.test(bd$quesi_abuso_emoc, bd$plaquetas) 
cor.test(bd$quesi_abuso_emoc, bd$plaquetas_vol)
cor.test(bd$quesi_abuso_emoc, bd$PCR)
cor.test(bd$quesi_abuso_emoc, bd$CRH)
cor.test(bd$quesi_abuso_emoc, bd$cortisol)

cor.test(bd$quesi_abuso_emoc, bd$anos_estudo)
cor.test(bd$quesi_abuso_emoc, bd$quant_pessoas)
cor.test(bd$quesi_abuso_emoc, bd$cigarros_semana)
cor.test(bd$quesi_abuso_emoc, bd$tempo_tabagismo)
cor.test(bd$quesi_abuso_emoc, bd$exercicio_tempo)
cor.test(bd$quesi_abuso_emoc, bd$internacao_quant)
cor.test(bd$quesi_abuso_emoc, bd$internacao_geral_quant)

#quesi_neglig_emoc
cor.test(bd$quesi_neglig_emoc, bd$quesi_abuso_sex)
cor.test(bd$quesi_neglig_emoc, bd$quesi_abuso_fis)
cor.test(bd$quesi_neglig_emoc, bd$quesi_neglig_fis)

cor.test(bd$quesi_neglig_emoc, bd$idade) 
cor.test(bd$quesi_neglig_emoc, bd$tempo_casado) 
cor.test(bd$quesi_neglig_emoc, bd$num_filhos) 
cor.test(bd$quesi_neglig_emoc, bd$renda_familia) 
cor.test(bd$quesi_neglig_emoc, bd$peso) 
cor.test(bd$quesi_neglig_emoc, bd$altura) 

cor.test(bd$quesi_neglig_emoc, bd$hemacias)
cor.test(bd$quesi_neglig_emoc, bd$hemoglobina)
cor.test(bd$quesi_neglig_emoc, bd$hematocrito)
cor.test(bd$quesi_neglig_emoc, bd$volumeglob) 
cor.test(bd$quesi_neglig_emoc, bd$hemoglobina_m) 
cor.test(bd$quesi_neglig_emoc, bd$hemoglobina_concent)
cor.test(bd$quesi_neglig_emoc, bd$rdw) 
cor.test(bd$quesi_neglig_emoc, bd$leucocitos)
cor.test(bd$quesi_neglig_emoc, bd$segmentados)
cor.test(bd$quesi_neglig_emoc, bd$segmentados_m)
cor.test(bd$quesi_neglig_emoc, bd$bastonados)
cor.test(bd$quesi_neglig_emoc, bd$linfocitos)
cor.test(bd$quesi_neglig_emoc, bd$linfocitos_m) 
cor.test(bd$quesi_neglig_emoc, bd$monocitos) 
cor.test(bd$quesi_neglig_emoc, bd$monocitos_m)
cor.test(bd$quesi_neglig_emoc, bd$eosinofilos)
cor.test(bd$quesi_neglig_emoc, bd$eosinofilos_m) 
cor.test(bd$quesi_neglig_emoc, bd$basofilos) 
cor.test(bd$quesi_neglig_emoc, bd$basofilos_m)
cor.test(bd$quesi_neglig_emoc, bd$plaquetas) 
cor.test(bd$quesi_neglig_emoc, bd$plaquetas_vol)
cor.test(bd$quesi_neglig_emoc, bd$PCR)
cor.test(bd$quesi_neglig_emoc, bd$CRH)
cor.test(bd$quesi_neglig_emoc, bd$cortisol)

cor.test(bd$quesi_neglig_emoc, bd$anos_estudo)
cor.test(bd$quesi_neglig_emoc, bd$quant_pessoas)
cor.test(bd$quesi_neglig_emoc, bd$cigarros_semana)
cor.test(bd$quesi_neglig_emoc, bd$tempo_tabagismo)
cor.test(bd$quesi_neglig_emoc, bd$exercicio_tempo)
cor.test(bd$quesi_neglig_emoc, bd$internacao_quant)
cor.test(bd$quesi_neglig_emoc, bd$internacao_geral_quant)

#quesi_abuso_sex
cor.test(bd$quesi_abuso_sex, bd$quesi_abuso_fis)
cor.test(bd$quesi_abuso_sex, bd$quesi_neglig_fis)

cor.test(bd$quesi_abuso_sex, bd$idade) 
cor.test(bd$quesi_abuso_sex, bd$tempo_casado) 
cor.test(bd$quesi_abuso_sex, bd$num_filhos) 
cor.test(bd$quesi_abuso_sex, bd$renda_familia) 
cor.test(bd$quesi_abuso_sex, bd$peso) 
cor.test(bd$quesi_abuso_sex, bd$altura) 

cor.test(bd$quesi_abuso_sex, bd$hemacias)
cor.test(bd$quesi_abuso_sex, bd$hemoglobina)
cor.test(bd$quesi_abuso_sex, bd$hematocrito)
cor.test(bd$quesi_abuso_sex, bd$volumeglob) 
cor.test(bd$quesi_abuso_sex, bd$hemoglobina_m) 
cor.test(bd$quesi_abuso_sex, bd$hemoglobina_concent)
cor.test(bd$quesi_abuso_sex, bd$rdw) 
cor.test(bd$quesi_abuso_sex, bd$leucocitos)
cor.test(bd$quesi_abuso_sex, bd$segmentados)
cor.test(bd$quesi_abuso_sex, bd$segmentados_m)
cor.test(bd$quesi_abuso_sex, bd$bastonados)
cor.test(bd$quesi_abuso_sex, bd$linfocitos)
cor.test(bd$quesi_abuso_sex, bd$linfocitos_m) 
cor.test(bd$quesi_abuso_sex, bd$monocitos) 
cor.test(bd$quesi_abuso_sex, bd$monocitos_m)
cor.test(bd$quesi_abuso_sex, bd$eosinofilos)
cor.test(bd$quesi_abuso_sex, bd$eosinofilos_m) 
cor.test(bd$quesi_abuso_sex, bd$basofilos) 
cor.test(bd$quesi_abuso_sex, bd$basofilos_m)
cor.test(bd$quesi_abuso_sex, bd$plaquetas) 
cor.test(bd$quesi_abuso_sex, bd$plaquetas_vol)
cor.test(bd$quesi_abuso_sex, bd$PCR)
cor.test(bd$quesi_abuso_sex, bd$CRH)
cor.test(bd$quesi_abuso_sex, bd$cortisol)

cor.test(bd$quesi_abuso_sex, bd$anos_estudo)
cor.test(bd$quesi_abuso_sex, bd$quant_pessoas)
cor.test(bd$quesi_abuso_sex, bd$cigarros_semana)
cor.test(bd$quesi_abuso_sex, bd$tempo_tabagismo)
cor.test(bd$quesi_abuso_sex, bd$exercicio_tempo)
cor.test(bd$quesi_abuso_sex, bd$internacao_quant)
cor.test(bd$quesi_abuso_sex, bd$internacao_geral_quant)

#quesi_abuso_fis
cor.test(bd$quesi_abuso_fis, bd$quesi_neglig_fis)

cor.test(bd$quesi_abuso_fis, bd$idade) 
cor.test(bd$quesi_abuso_fis, bd$tempo_casado) 
cor.test(bd$quesi_abuso_fis, bd$num_filhos) 
cor.test(bd$quesi_abuso_fis, bd$renda_familia) 
cor.test(bd$quesi_abuso_fis, bd$peso) 
cor.test(bd$quesi_abuso_fis, bd$altura) 

cor.test(bd$quesi_abuso_fis, bd$hemacias)
cor.test(bd$quesi_abuso_fis, bd$hemoglobina)
cor.test(bd$quesi_abuso_fis, bd$hematocrito)
cor.test(bd$quesi_abuso_fis, bd$volumeglob) 
cor.test(bd$quesi_abuso_fis, bd$hemoglobina_m) 
cor.test(bd$quesi_abuso_fis, bd$hemoglobina_concent)
cor.test(bd$quesi_abuso_fis, bd$rdw) 
cor.test(bd$quesi_abuso_fis, bd$leucocitos)
cor.test(bd$quesi_abuso_fis, bd$segmentados)
cor.test(bd$quesi_abuso_fis, bd$segmentados_m)
cor.test(bd$quesi_abuso_fis, bd$bastonados)
cor.test(bd$quesi_abuso_fis, bd$linfocitos)
cor.test(bd$quesi_abuso_fis, bd$linfocitos_m) 
cor.test(bd$quesi_abuso_fis, bd$monocitos) 
cor.test(bd$quesi_abuso_fis, bd$monocitos_m)
cor.test(bd$quesi_abuso_fis, bd$eosinofilos)
cor.test(bd$quesi_abuso_fis, bd$eosinofilos_m) 
cor.test(bd$quesi_abuso_fis, bd$basofilos) 
cor.test(bd$quesi_abuso_fis, bd$basofilos_m)
cor.test(bd$quesi_abuso_fis, bd$plaquetas) 
cor.test(bd$quesi_abuso_fis, bd$plaquetas_vol)
cor.test(bd$quesi_abuso_fis, bd$PCR)
cor.test(bd$quesi_abuso_fis, bd$CRH)
cor.test(bd$quesi_abuso_fis, bd$cortisol)

cor.test(bd$quesi_abuso_fis, bd$anos_estudo)
cor.test(bd$quesi_abuso_fis, bd$quant_pessoas)
cor.test(bd$quesi_abuso_fis, bd$cigarros_semana)
cor.test(bd$quesi_abuso_fis, bd$tempo_tabagismo)
cor.test(bd$quesi_abuso_fis, bd$exercicio_tempo)
cor.test(bd$quesi_abuso_fis, bd$internacao_quant)
cor.test(bd$quesi_abuso_fis, bd$internacao_geral_quant)

#quesi_abuso_fis

cor.test(bd$quesi_neglig_fis, bd$idade) 
cor.test(bd$quesi_neglig_fis, bd$tempo_casado) 
cor.test(bd$quesi_neglig_fis, bd$num_filhos) 
cor.test(bd$quesi_neglig_fis, bd$renda_familia) 
cor.test(bd$quesi_neglig_fis, bd$peso) 
cor.test(bd$quesi_neglig_fis, bd$altura) 

cor.test(bd$quesi_neglig_fis, bd$hemacias)
cor.test(bd$quesi_neglig_fis, bd$hemoglobina)
cor.test(bd$quesi_neglig_fis, bd$hematocrito)
cor.test(bd$quesi_neglig_fis, bd$volumeglob) 
cor.test(bd$quesi_neglig_fis, bd$hemoglobina_m) 
cor.test(bd$quesi_neglig_fis, bd$hemoglobina_concent)
cor.test(bd$quesi_neglig_fis, bd$rdw) 
cor.test(bd$quesi_neglig_fis, bd$leucocitos)
cor.test(bd$quesi_neglig_fis, bd$segmentados)
cor.test(bd$quesi_neglig_fis, bd$segmentados_m)
cor.test(bd$quesi_neglig_fis, bd$bastonados)
cor.test(bd$quesi_neglig_fis, bd$linfocitos)
cor.test(bd$quesi_neglig_fis, bd$linfocitos_m) 
cor.test(bd$quesi_neglig_fis, bd$monocitos) 
cor.test(bd$quesi_neglig_fis, bd$monocitos_m)
cor.test(bd$quesi_neglig_fis, bd$eosinofilos)
cor.test(bd$quesi_neglig_fis, bd$eosinofilos_m) 
cor.test(bd$quesi_neglig_fis, bd$basofilos) 
cor.test(bd$quesi_neglig_fis, bd$basofilos_m)
cor.test(bd$quesi_neglig_fis, bd$plaquetas) 
cor.test(bd$quesi_neglig_fis, bd$plaquetas_vol)
cor.test(bd$quesi_neglig_fis, bd$PCR)
cor.test(bd$quesi_neglig_fis, bd$CRH)
cor.test(bd$quesi_neglig_fis, bd$cortisol)

cor.test(bd$quesi_neglig_fis, bd$anos_estudo)
cor.test(bd$quesi_neglig_fis, bd$quant_pessoas)
cor.test(bd$quesi_neglig_fis, bd$cigarros_semana)
cor.test(bd$quesi_neglig_fis, bd$tempo_tabagismo)
cor.test(bd$quesi_neglig_fis, bd$exercicio_tempo)
cor.test(bd$quesi_neglig_fis, bd$internacao_quant)
cor.test(bd$quesi_neglig_fis, bd$internacao_geral_quant)

##anos_estudos
cor.test(bd$anos_estudo, bd$quant_pessoas)
cor.test(bd$anos_estudo, bd$cigarros_semana)
cor.test(bd$anos_estudo, bd$tempo_tabagismo)
cor.test(bd$anos_estudo, bd$exercicio_tempo)
cor.test(bd$anos_estudo, bd$internacao_quant)
cor.test(bd$anos_estudo, bd$internacao_geral_quant)

cor.test(bd$anos_estudo, bd$hemacias)
cor.test(bd$anos_estudo, bd$hemoglobina) 
cor.test(bd$anos_estudo, bd$hematocrito) 
cor.test(bd$anos_estudo, bd$volumeglob) 
cor.test(bd$anos_estudo, bd$hemoglobina_m)
cor.test(bd$anos_estudo, bd$hemoglobina_concent) 
cor.test(bd$anos_estudo, bd$rdw) 
cor.test(bd$anos_estudo, bd$leucocitos) 
cor.test(bd$anos_estudo, bd$segmentados)
cor.test(bd$anos_estudo, bd$segmentados_m) 
cor.test(bd$anos_estudo, bd$bastonados) 
cor.test(bd$anos_estudo, bd$linfocitos) 
cor.test(bd$anos_estudo, bd$linfocitos_m) 
cor.test(bd$anos_estudo, bd$monocitos) 
cor.test(bd$anos_estudo, bd$monocitos_m)
cor.test(bd$anos_estudo, bd$eosinofilos) 
cor.test(bd$anos_estudo, bd$eosinofilos_m) 
cor.test(bd$anos_estudo, bd$basofilos)
cor.test(bd$anos_estudo, bd$basofilos_m) 
cor.test(bd$anos_estudo, bd$plaquetas) 
cor.test(bd$anos_estudo, bd$plaquetas_vol) 
cor.test(bd$anos_estudo, bd$PCR)
cor.test(bd$anos_estudo, bd$CRH)
cor.test(bd$anos_estudo, bd$cortisol)

##quant_pessoas
cor.test(bd$quant_pessoas, bd$cigarros_semana)
cor.test(bd$quant_pessoas, bd$tempo_tabagismo)
cor.test(bd$quant_pessoas, bd$exercicio_tempo)
cor.test(bd$quant_pessoas, bd$internacao_quant)
cor.test(bd$quant_pessoas, bd$internacao_geral_quant)

cor.test(bd$quant_pessoas, bd$hemacias)
cor.test(bd$quant_pessoas, bd$hemoglobina) 
cor.test(bd$quant_pessoas, bd$hematocrito) 
cor.test(bd$quant_pessoas, bd$volumeglob) 
cor.test(bd$quant_pessoas, bd$hemoglobina_m)
cor.test(bd$quant_pessoas, bd$hemoglobina_concent) 
cor.test(bd$quant_pessoas, bd$rdw) 
cor.test(bd$quant_pessoas, bd$leucocitos) 
cor.test(bd$quant_pessoas, bd$segmentados)
cor.test(bd$quant_pessoas, bd$segmentados_m) 
cor.test(bd$quant_pessoas, bd$bastonados) 
cor.test(bd$quant_pessoas, bd$linfocitos) 
cor.test(bd$quant_pessoas, bd$linfocitos_m) 
cor.test(bd$quant_pessoas, bd$monocitos) 
cor.test(bd$quant_pessoas, bd$monocitos_m)
cor.test(bd$quant_pessoas, bd$eosinofilos) 
cor.test(bd$quant_pessoas, bd$eosinofilos_m) 
cor.test(bd$quant_pessoas, bd$basofilos)
cor.test(bd$quant_pessoas, bd$basofilos_m) 
cor.test(bd$quant_pessoas, bd$plaquetas) 
cor.test(bd$quant_pessoas, bd$plaquetas_vol) 
cor.test(bd$quant_pessoas, bd$PCR)
cor.test(bd$quant_pessoas, bd$CRH)
cor.test(bd$quant_pessoas, bd$cortisol)

##cigarros_semana
cor.test(bd$cigarros_semana, bd$tempo_tabagismo)
cor.test(bd$cigarros_semana, bd$exercicio_tempo)
cor.test(bd$cigarros_semana, bd$internacao_quant)
cor.test(bd$cigarros_semana, bd$internacao_geral_quant)

cor.test(bd$cigarros_semana, bd$hemacias)
cor.test(bd$cigarros_semana, bd$hemoglobina) 
cor.test(bd$cigarros_semana, bd$hematocrito) 
cor.test(bd$cigarros_semana, bd$volumeglob) 
cor.test(bd$cigarros_semana, bd$hemoglobina_m)
cor.test(bd$cigarros_semana, bd$hemoglobina_concent) 
cor.test(bd$cigarros_semana, bd$rdw) 
cor.test(bd$cigarros_semana, bd$leucocitos) 
cor.test(bd$cigarros_semana, bd$segmentados)
cor.test(bd$cigarros_semana, bd$segmentados_m) 
cor.test(bd$cigarros_semana, bd$bastonados) 
cor.test(bd$cigarros_semana, bd$linfocitos) 
cor.test(bd$cigarros_semana, bd$linfocitos_m) 
cor.test(bd$cigarros_semana, bd$monocitos) 
cor.test(bd$cigarros_semana, bd$monocitos_m)
cor.test(bd$cigarros_semana, bd$eosinofilos) 
cor.test(bd$cigarros_semana, bd$eosinofilos_m) 
cor.test(bd$cigarros_semana, bd$basofilos)
cor.test(bd$cigarros_semana, bd$basofilos_m) 
cor.test(bd$cigarros_semana, bd$plaquetas) 
cor.test(bd$cigarros_semana, bd$plaquetas_vol) 
cor.test(bd$cigarros_semana, bd$PCR)
cor.test(bd$cigarros_semana, bd$CRH)
cor.test(bd$cigarros_semana, bd$cortisol)

##tempo_tabagismo
cor.test(bd$tempo_tabagismo, bd$exercicio_tempo)
cor.test(bd$tempo_tabagismo, bd$internacao_quant)
cor.test(bd$tempo_tabagismo, bd$internacao_geral_quant)

cor.test(bd$tempo_tabagismo, bd$hemacias)
cor.test(bd$tempo_tabagismo, bd$hemoglobina) 
cor.test(bd$tempo_tabagismo, bd$hematocrito) 
cor.test(bd$tempo_tabagismo, bd$volumeglob) 
cor.test(bd$tempo_tabagismo, bd$hemoglobina_m)
cor.test(bd$tempo_tabagismo, bd$hemoglobina_concent) 
cor.test(bd$tempo_tabagismo, bd$rdw) 
cor.test(bd$tempo_tabagismo, bd$leucocitos) 
cor.test(bd$tempo_tabagismo, bd$segmentados)
cor.test(bd$tempo_tabagismo, bd$segmentados_m) 
cor.test(bd$tempo_tabagismo, bd$bastonados) 
cor.test(bd$tempo_tabagismo, bd$linfocitos) 
cor.test(bd$tempo_tabagismo, bd$linfocitos_m) 
cor.test(bd$tempo_tabagismo, bd$monocitos) 
cor.test(bd$tempo_tabagismo, bd$monocitos_m)
cor.test(bd$tempo_tabagismo, bd$eosinofilos) 
cor.test(bd$tempo_tabagismo, bd$eosinofilos_m) 
cor.test(bd$tempo_tabagismo, bd$basofilos)
cor.test(bd$tempo_tabagismo, bd$basofilos_m) 
cor.test(bd$tempo_tabagismo, bd$plaquetas) 
cor.test(bd$tempo_tabagismo, bd$plaquetas_vol) 
cor.test(bd$tempo_tabagismo, bd$PCR)
cor.test(bd$tempo_tabagismo, bd$CRH)
cor.test(bd$tempo_tabagismo, bd$cortisol)

##exercicio_tempo
cor.test(bd$exercicio_tempo, bd$internacao_quant)
cor.test(bd$exercicio_tempo, bd$internacao_geral_quant)

cor.test(bd$exercicio_tempo, bd$hemacias)
cor.test(bd$exercicio_tempo, bd$hemoglobina) 
cor.test(bd$exercicio_tempo, bd$hematocrito) 
cor.test(bd$exercicio_tempo, bd$volumeglob) 
cor.test(bd$exercicio_tempo, bd$hemoglobina_m)
cor.test(bd$exercicio_tempo, bd$hemoglobina_concent) 
cor.test(bd$exercicio_tempo, bd$rdw) 
cor.test(bd$exercicio_tempo, bd$leucocitos) 
cor.test(bd$exercicio_tempo, bd$segmentados)
cor.test(bd$exercicio_tempo, bd$segmentados_m) 
cor.test(bd$exercicio_tempo, bd$bastonados) 
cor.test(bd$exercicio_tempo, bd$linfocitos) 
cor.test(bd$exercicio_tempo, bd$linfocitos_m) 
cor.test(bd$exercicio_tempo, bd$monocitos) 
cor.test(bd$exercicio_tempo, bd$monocitos_m)
cor.test(bd$exercicio_tempo, bd$eosinofilos) 
cor.test(bd$exercicio_tempo, bd$eosinofilos_m) 
cor.test(bd$exercicio_tempo, bd$basofilos)
cor.test(bd$exercicio_tempo, bd$basofilos_m) 
cor.test(bd$exercicio_tempo, bd$plaquetas) 
cor.test(bd$exercicio_tempo, bd$plaquetas_vol) 
cor.test(bd$exercicio_tempo, bd$PCR)
cor.test(bd$exercicio_tempo, bd$CRH)
cor.test(bd$exercicio_tempo, bd$cortisol)

##internacao_quant
cor.test(bd$internacao_quant, bd$internacao_geral_quant)

cor.test(bd$internacao_quant, bd$hemacias)
cor.test(bd$internacao_quant, bd$hemoglobina) 
cor.test(bd$internacao_quant, bd$hematocrito) 
cor.test(bd$internacao_quant, bd$volumeglob) 
cor.test(bd$internacao_quant, bd$hemoglobina_m)
cor.test(bd$internacao_quant, bd$hemoglobina_concent) 
cor.test(bd$internacao_quant, bd$rdw) 
cor.test(bd$internacao_quant, bd$leucocitos) 
cor.test(bd$internacao_quant, bd$segmentados)
cor.test(bd$internacao_quant, bd$segmentados_m) 
cor.test(bd$internacao_quant, bd$bastonados) 
cor.test(bd$internacao_quant, bd$linfocitos) 
cor.test(bd$internacao_quant, bd$linfocitos_m) 
cor.test(bd$internacao_quant, bd$monocitos) 
cor.test(bd$internacao_quant, bd$monocitos_m)
cor.test(bd$internacao_quant, bd$eosinofilos) 
cor.test(bd$internacao_quant, bd$eosinofilos_m) 
cor.test(bd$internacao_quant, bd$basofilos)
cor.test(bd$internacao_quant, bd$basofilos_m) 
cor.test(bd$internacao_quant, bd$plaquetas) 
cor.test(bd$internacao_quant, bd$plaquetas_vol) 
cor.test(bd$internacao_quant, bd$PCR)
cor.test(bd$internacao_quant, bd$CRH)
cor.test(bd$internacao_quant, bd$cortisol)

##internacao_geral_quant
cor.test(bd$internacao_geral_quant, bd$hemacias)
cor.test(bd$internacao_geral_quant, bd$hemoglobina) 
cor.test(bd$internacao_geral_quant, bd$hematocrito) 
cor.test(bd$internacao_geral_quant, bd$volumeglob) 
cor.test(bd$internacao_geral_quant, bd$hemoglobina_m)
cor.test(bd$internacao_geral_quant, bd$hemoglobina_concent) 
cor.test(bd$internacao_geral_quant, bd$rdw) 
cor.test(bd$internacao_geral_quant, bd$leucocitos) 
cor.test(bd$internacao_geral_quant, bd$segmentados)
cor.test(bd$internacao_geral_quant, bd$segmentados_m) 
cor.test(bd$internacao_geral_quant, bd$bastonados) 
cor.test(bd$internacao_geral_quant, bd$linfocitos) 
cor.test(bd$internacao_geral_quant, bd$linfocitos_m) 
cor.test(bd$internacao_geral_quant, bd$monocitos) 
cor.test(bd$internacao_geral_quant, bd$monocitos_m)
cor.test(bd$internacao_geral_quant, bd$eosinofilos) 
cor.test(bd$internacao_geral_quant, bd$eosinofilos_m) 
cor.test(bd$internacao_geral_quant, bd$basofilos)
cor.test(bd$internacao_geral_quant, bd$basofilos_m) 
cor.test(bd$internacao_geral_quant, bd$plaquetas) 
cor.test(bd$internacao_geral_quant, bd$plaquetas_vol) 
cor.test(bd$internacao_geral_quant, bd$PCR)
cor.test(bd$internacao_geral_quant, bd$CRH)
cor.test(bd$internacao_geral_quant, bd$cortisol)

cor.test(bd$teps_total, bd$imc)
cor.test(bd$teps_total, bd$exercicio_duracao)
...
#matriz
n <- nrow(M2cor)
cold2 <- colindiag(M2cor, n = n)
print(cold2)
##CN = 51850,303

n4 <- nrow(M4cor)
cold4 <- colindiag(M4cor, n = n4)
print(cold4)
##CN = 9,367
